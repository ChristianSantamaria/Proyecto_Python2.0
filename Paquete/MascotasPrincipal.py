...
class MascotasPrincipal(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.override_background_color(Gtk.StateType.NORMAL, Gdk.RGBA(211, 227, 253))
...
class MascotasRegistro(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.frameCrear.modify_bg(Gtk.StateType.NORMAL, Gdk.Color(51657, 65278, 53970))
        ...
        self.frameMod.modify_bg(Gtk.StateType.NORMAL, Gdk.Color(46774, 61166, 63479))
        ...
        self.frameEliminar.modify_bg(Gtk.StateType.NORMAL, Gdk.Color(65535, 46003, 46003))
...
class MascotasListado(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.cajaVentana.modify_bg(Gtk.StateType.NORMAL, Gdk.Color(65535, 63000, 62000))
...
class MascotasClientes(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.frameDere.modify_bg(Gtk.StateType.NORMAL, Gdk.Color(51657, 65278, 53970))
        ...
        self.frameCentro.modify_bg(Gtk.StateType.NORMAL, Gdk.Color(46774, 61166, 63479))
        ...
        self.frameIzq.modify_bg(Gtk.StateType.NORMAL, Gdk.Color(65535, 46003, 46003))
